...
//        let addedFavorites = existedFavorites.append(model?)
...
//        let existedFavorites = UserDefaults.standard.array(forKey: "favorites")
        
        let decoded  = UserDefaults.standard.object(forKey: "favorites") as! Data
        let decodedFavorites = try? NSKeyedUnarchiver.unarchiveTopLevelObjectWithData(decoded) as? [NewsCollectionViewCellModel]
        print(decodedFavorites, "<<<")
